...
namespace Keane.CH.Framework.DataAccess.ORM
{
    ...
    public sealed class ORMapper
    {
        ...
        /// <summary>
        /// Adds a list of db parameter to the passed db command.
        /// </summary>
        ...
        public static void AddMappedParameterList(
            ...
            object instance)
        {
            ...
            // Map accordingly.
            mappings.ForEach(m => AddMappedParameter(m, db, cmd, instance));
        }
            ...
            object instance)
        {
            ...
            // Map default members.
            mappings.ForEach(m => Map(m, dr, instance));
            ...
            if (mappings.Count > 0)
            {
                ...
                if (entity != null)
                    mappings.ForEach(m => Map(m, dr, entity.EntityInfo));
            }
        ...
        /// <summary>
        /// Adds a db parameter to the passed db command.
        /// </summary>
        /// <param name="mapping">A mapping.</param>
        /// <param name="db">A database against which the command will be executed.</param>
        /// <param name="cmd">A command being prepared for execution.</param>
        /// <param name="instance">An object being mapped to a DbCommand.</param>
        private static void AddMappedParameter(
            ORMapping mapping,
            Database db,
            DbCommand cmd,
            object instance)
            ...
            ORMapping mapping, PropertyInfo pi)
        {
                ...
                (mapping.DbParameterType == ORMappingDbParameterType.Undefined))
            {
                ...
                if (typeof(int).Equals(pi.PropertyType))
                    ...
                    derived = ORMappingDbParameterType.Decimal;
