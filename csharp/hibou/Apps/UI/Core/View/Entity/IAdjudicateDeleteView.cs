...
{
    /// <summary>
    /// Encapsulates the data required for a modicifation delete adjudication.
    /// </summary>
    public interface IAdjudicateDeleteView
    {
        /// <summary>
        ...
        void RenderForTargetEntity(int entityTypeId, int entityId, bool requiresDecision);
    }
}