/**
 * @fileOverview Subscription pushed to counter parties when settlement is irreverisible.
 */
...
const EVENT_NAME = 'onSettlementFinalise';
...
const subscribe = withFilter(
    ...
    // Predicate.
    (payload, { input }) => {
        const doPublish = payload.onSettlementFinalise.customerID === input.customerID;
        if (doPublish) {
